...
class AlertsUiStructureTests(unittest.TestCase):
    ...
    def test_alert_detail_view_elements_exist(self):
        ...
        self.assertIn('id="action-plan-linear-detail-table"', html)
        ...
        self.assertIn('class="sortable" data-sort-key="target_band">Linear Target Band</th>', html)
        ...
        self.assertIn('actionPlanLinearDetailSortHeaders', js)
        self.assertIn("let actionPlanLinearSort = { key: 'linear_allocation_score', direction: 'desc' }", js)
        self.assertIn("let actionPlanLinearDetailSort = { key: 'linear_allocation_score', direction: 'desc' }", js)
        self.assertIn('sortLinearActionPlanDetailItems', js)
