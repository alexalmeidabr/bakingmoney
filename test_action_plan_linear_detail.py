...
class LinearActionPlanDetailTests(unittest.TestCase):
    ...
    def test_detail_exposes_current_score_target_cap_reserve_and_execution_diagnostics(self):
        ...
        self.assertEqual(detail["linear_score_allocation_power"], row["linear_score_allocation_power"])
        self.assertEqual(detail["linear_powered_score"], row["linear_powered_score"])
        self.assertEqual(detail["linear_total_powered_score"], row["linear_total_powered_score"])
        self.assertEqual(detail["linear_target_allocation_pool"], row["linear_target_allocation_pool"])
        ...
        self.assertEqual(score["linear_score_before_penalty"], row["linear_score_before_penalty"])
        self.assertEqual(score["linear_score_after_penalty"], row["linear_score_after_penalty"])
        self.assertEqual(score["linear_score_before_min_threshold"], row["linear_score_before_min_threshold"])
        self.assertEqual(score["linear_min_score_threshold"], row["linear_min_score_threshold"])
        self.assertEqual(score["linear_min_score_threshold_applied"], row["linear_min_score_threshold_applied"])
