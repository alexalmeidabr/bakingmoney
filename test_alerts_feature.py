...
class AlertsUiStructureTests(unittest.TestCase):
    ...
    def test_alert_detail_view_elements_exist(self):
        ...
        self.assertIn('#action-plan-table th:nth-child(3)', css)
        ...
        self.assertIn('<th>Bucket Sizing Score</th><th>Target Mid Before Caps</th>', js)
        self.assertNotIn('<th>Symbol</th><th>Company Name</th><th>Action</th>', js)
